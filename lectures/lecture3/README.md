...
> リポ名は `[s2331072]-web3ai-2026` に統一(本名ではなく Discord ID を使う)。
...
2. 中身を新規ディレクトリ「[s2331072]-web3ai-2026」にコピー(.git 再初期化)
3. 私の新規 GitHub リポを作成: `gh repo create [s2331072]-web3ai-2026 --public`
